...
- Built an end-to-end ML pipeline achieving F1 of 0.95, ROC-AUC of 0.81 on imbalanced campaign data.  
- Increased minority-class recall from 0.76 to 0.99 using SMOTE and threshold optimization.  
- Applied SHAP to identify top conversion drivers and optimized campaign ROI, reducing wasted ad spend.
